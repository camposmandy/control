...
class CoreDataManager {
    ...
    func fetchData (entidadeNome : String, predicate: NSPredicate) -> Array <AnyObject> {
        ...
        let requisicao = NSFetchRequest()
        let entityDescription = NSEntityDescription.entityForName(entidadeNome, inManagedObjectContext: self.managedObjectContext!)
        requisicao.entity = entityDescription
        var result1 = [AnyObject]()
        
        do {
            let result = try self.managedObjectContext?.executeFetchRequest(requisicao)
            result1 = result!
        } catch {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("control", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        do {
            ...
            NSLog("Unresolved error \(error), \(wrappedError.userInfo)")
            abort()
        }
